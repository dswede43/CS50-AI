...
class Sentence():
    ...
    def known_mines(self):
        ...
        """
        #if count of mines equals the number of cells and not zero, all cells are mines
    ...
    def known_safes(self):
        ...
        """
        #if count of mines is zero, all cells are safe
        if self.count == 0:
            return self.cells
        return set()
    ...
    def mark_mine(self, cell):
        ...
        """
        #if the cell is in senetence, remove it and decrement the count
    ...
    def mark_safe(self, cell):
        ...
        """
        #if the cell is in sentence, remove it
        if cell in self.cells:
            self.cells.remove(cell)
...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        """
        #1. mark cell as a move played
        self.moves_made.add(cell)

        #2. mark cell as safe
        self.mark_safe(cell)

        #3. add new sentence to knowledge base based on value of `cell` and `count`
        undetermined_cells = []
        count_mines = 0
        for i in range(cell[0] - 1, cell[0] + 2):
            for j in range(cell[1] - 1, cell[1] + 2):
        ...
        #4. mark any additional cells as safe or as mines if it can be concluded based on the knowledge base
    ...
    def make_safe_move(self):
        ...
        """
        #get the set of safe cells that are not already played moves
    ...
    def make_random_move(self):
        ...
        #get list of all possible movies that are not mines
        for i in range(self.height):
            for j in range(self.width):
                if (i, j) not in self.moves_made and (i, j) not in self.mines:
                    #append cell to list of possible moves
                    possible_moves.append((i, j))

        #if list of possible moves is not zero
